      ...
      <main>
        ...
        >
          <div style={{ marginBottom: "20px" }}>
            <span style={{ fontSize: "18px", opacity: "0.8" }}>Security</span>
          </div>
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                Our in-house security experts drive the secure development and operation of our products and
                infrastructure.
              </p>
            </div>
            ...
            <div style={{ textAlign: "left" }}>
              ...
              >
                Top experts from major financial institutions and cloud providers guide our security and privacy
                program.
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <h3 style={{ fontSize: "18px", marginBottom: "15px" }}>Data Encryption</h3>
              ...
              <div>
                ...
                <h3 style={{ fontSize: "18px", marginBottom: "15px" }}>SOC 2 Compliance</h3>
                <p style={{ fontSize: "16px", opacity: "0.8", lineHeight: "1.6" }}>
                  Our platform adheres to SOC 2 Type II standards for security, availability, and confidentiality.
                </p>
              </div>
              ...
              <div>
                ...
                <h3 style={{ fontSize: "18px", marginBottom: "15px" }}>Access Controls</h3>
                <p style={{ fontSize: "16px", opacity: "0.8", lineHeight: "1.6" }}>
              ...
              <div>
                ...
                <h3 style={{ fontSize: "18px", marginBottom: "15px" }}>Regular Audits</h3>
                <p style={{ fontSize: "16px", opacity: "0.8", lineHeight: "1.6" }}>
